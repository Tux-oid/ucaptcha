<?php
class MoreLess implements PluginInterface
{
	...
	function generateImage($canvas)
	{
		...
		for ($i=0;$i<strlen($rand);$i++)
		{
			...
			imagefttext($canvas, 14, rand (-10,10), 24+14*$i, 50, $color, $this->ucaptcha->getCaptchaFontPath()."/LiberationMono-Bold.ttf", $rand[$i]);
		}
